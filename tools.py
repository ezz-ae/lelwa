...
class ToolExecutor:
    ...
    def execute(self, name: str, args: dict, session_id: str = None) -> dict:
        ...
        if method:
            try:
                ...
                return {"error": str(e)}
        return {"error": f"Tool {name} is not yet implemented in the executor."}
    ...
    def tool_generate_document_pdf(self, args: dict, session_id: str):
        ...
        pdf.multi_cell(0, 5, "Disclaimer: This document is generated by Lelwa Intelligence. Projections are estimates based on DLD data and are not guaranteed.")
    ...
    def tool_send_whatsapp(self, args: dict, session_id: str):
        ...
        msg_args = {
            ...
            "body": args.get('message_body', f"Hi {args.get('investor_name', 'Investor')}, Lelwa has an update for you.")
        }
        if media_url:
