...
export default function ChatInput({ placeholder = "Share the lead, deliverable, or next step you want prepared.", onSend }: ChatInputProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    Promise.resolve(onSend?.(trimmed) ?? console.log("Submitted:", trimmed))
      .catch((error) => {
        console.error("Chat input send error", error)
      })
      .finally(() => {
        setInput("")
        setIsSending(false)
